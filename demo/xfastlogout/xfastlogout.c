...
static void xfastlogout_atevent (s_window_t *window, s_event_t *event)
{
	/* never loose focus */
...
static void xfastlogout_cancel (s_window_t *window, s_event_t *event, s_handler_t *handler)
{
	s_window_quit(window);
}

static void xfastlogout_logout (s_window_t *window, s_event_t *event, s_handler_t *handler)
{
...
int main (int argc, char *argv[])
{
	...
	s_window_set_title(window, "XFast logout");
	...
	s_window_atevent(window, xfastlogout_atevent);
	...
	s_font_set_str(font, "Close XFast Windowing System...");
	...
	hndl->mouse.w = 35;
	hndl->mouse.h = 35;
	hndl->mouse.r = xfastlogout_logout;
	...
	hndl->mouse.w = 35;
	hndl->mouse.h = 35;
	hndl->mouse.r = xfastlogout_cancel;
	hndl->mouse.button = MOUSE_BUTTON_LEFT;
	s_handler_add(window, hndl);
...
s_single_app_t single_xfastlogout = {
	main,
	1,
	{"xfastlogout"}
};
