...
/*150 */{480,	272,	1 << 24, 480 * 3,  3, "480x272x16M",    M480x272x16M},
...
/*160 */{1280,  800,    1 << 16, 1280 *2,  2, "1280x800x64K",   M1280x800x64K},
	{720,   576,    1 << 16, 720 * 2,  2, "720x576x64K",    M720x576x64K},
	{640,   512,    1 << 16, 640 * 2,  2, "640x512x64K",    M640x512x64K},
};
